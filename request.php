...
if(isset($_POST['email'])) {
    ...
    $comments = $_POST['ref']; // required
	$subject = $_POST['subject']; //required
  
    $email_message = "Request.\n\n";
    ...
    $email_message .= "Reference: ".clean_string($comments)."\n";
...
<h2 style="color: white; font-family: calibri;">Your Request have been submitted. :) </h2>
